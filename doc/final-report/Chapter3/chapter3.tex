...
\subsection{Build Process}
  ...
  \subsection{Development Environment}
    ...
    All of the code and LaTeX will be written with the editor Vim, which has been configured to have many optimisations to this workflow. For instance while writing a LaTeX report a preview PDF window will automatically update when changes are made. Similarly any syntax errors will be highlighted as soon as they are made, and then (if possible) automatically fixed when saved. The full Vim configuration that was used can be found here\cite{.vimrc}.
