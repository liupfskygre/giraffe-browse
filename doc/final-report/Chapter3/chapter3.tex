...
Using this boilerplate will save a huge amount of time in development as the basic framework of the web application is already laid out, it just needs the developer to hone it to become specific to the intended purpose. 
